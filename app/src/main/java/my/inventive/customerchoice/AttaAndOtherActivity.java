...
public class AttaAndOtherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Atta & Other Flours");
                ...
                if (sucess.equals("1")) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                       ...
                       String category=object.getString("item_category");
                        ...
                        if (category.equals("Atta and other Flours") && seller_id.equals("27")) {
    ...
    public void onBackPressed() {
        startActivity(new Intent(AttaAndOtherActivity.this,MainActivity.class));
        finish();
    }
}
