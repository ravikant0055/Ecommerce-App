...
public class  ReadyMadeMeals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ready_made_meals);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Ready Made Meals");
        ...
        progressDialog=new ProgressDialog(ReadyMadeMeals.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Ready Made Meals") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ReadyMadeMeals.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(ReadyMadeMeals.this,MainActivity.class));
        finish();
    }
