...
public class MouthAndMansCare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mouth_and_mans_care);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Mouth And Man's Care");
        ...
        progressDialog = new ProgressDialog(MouthAndMansCare.this, R.style.MyAlertDialogStyle);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Mouths and Mans Care") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MouthAndMansCare.this, "" + error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(MouthAndMansCare.this,MainActivity.class));
        finish();
    }
}
