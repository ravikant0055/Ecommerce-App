...
public class PastaAndNoodles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pasta_and_noodles);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Pasta and Noodles");
        ...
        progressDialog=new ProgressDialog(PastaAndNoodles.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Pasta and Noodles") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PastaAndNoodles.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(PastaAndNoodles.this,MainActivity.class));
        finish();
    }
}
