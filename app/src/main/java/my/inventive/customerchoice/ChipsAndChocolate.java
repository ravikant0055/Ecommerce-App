...
public class ChipsAndChocolate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chips_and_chocolate);


        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Chips and Chocolates");
        ...
        progressDialog=new ProgressDialog(ChipsAndChocolate.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Chips and Chocolates") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ChipsAndChocolate.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(ChipsAndChocolate.this,MainActivity.class));
        finish();
    }
}
