...
public class MosqitoAndRespellents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mosqito_and_respellents);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Mosquito And Respellants");
        ...
        progressDialog=new ProgressDialog(MosqitoAndRespellents.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Mosquito Respellents") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MosqitoAndRespellents.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(MosqitoAndRespellents.this,MainActivity.class));
        finish();
    }
}
