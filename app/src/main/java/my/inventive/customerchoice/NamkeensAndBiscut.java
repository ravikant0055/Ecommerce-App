...
public class NamkeensAndBiscut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_namkeens_and_biscut);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Namkeens and Biscuits");
        ...
        progressDialog=new ProgressDialog(NamkeensAndBiscut.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Namkeens and Biscuits") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(NamkeensAndBiscut.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(NamkeensAndBiscut.this,MainActivity.class));
        finish();
    }
}
