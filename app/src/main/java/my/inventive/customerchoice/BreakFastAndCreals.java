...
public class BreakFastAndCreals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_break_fast_and_creals);
        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Breakfast and Cereals");
        ...
        progressDialog=new ProgressDialog(BreakFastAndCreals.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Breakfast and Cereals")&& seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BreakFastAndCreals.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(BreakFastAndCreals.this,MainActivity.class));
        finish();
    }
}
