...
public class BathAndWashCare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bath_and_wash_care);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Bath And Wash Care");
        ...
        progressDialog = new ProgressDialog(BathAndWashCare.this, R.style.MyAlertDialogStyle);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Bath and Wash Care") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BathAndWashCare.this, "" + error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(BathAndWashCare.this,MainActivity.class));
        finish();
    }
}
