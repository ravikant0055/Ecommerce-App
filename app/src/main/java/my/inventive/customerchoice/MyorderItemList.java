...
import my.inventive.customerchoice.Adapters.MyorderItemList_Adapter;
...
public class MyorderItemList extends AppCompatActivity {
    private static final String apiurl="https://simplyfied.co.in/groceryapp/historyorderitem.php";
