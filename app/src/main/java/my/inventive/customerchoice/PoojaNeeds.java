...
public class PoojaNeeds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pooja_needs);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Pooja Needs");
        ...
        progressDialog=new ProgressDialog(PoojaNeeds.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Pooja Needs") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PoojaNeeds.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(PoojaNeeds.this,MainActivity.class));
        finish();
    }
}
