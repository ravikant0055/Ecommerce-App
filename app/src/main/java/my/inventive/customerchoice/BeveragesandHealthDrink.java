...
public class BeveragesandHealthDrink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beveragesand_health_drink);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Beverages and Health Drinks");
        ...
        progressDialog=new ProgressDialog(BeveragesandHealthDrink.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Beverages and Health Drinks") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BeveragesandHealthDrink.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(BeveragesandHealthDrink.this,MainActivity.class));
        finish();
    }
}
