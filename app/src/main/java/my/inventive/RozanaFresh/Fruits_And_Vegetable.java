...
public class Fruits_And_Vegetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruits__and__vegetable);
        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Fruits & Vegetables");
        ...
        progressDialog=new ProgressDialog(Fruits_And_Vegetable.this, R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Fruits And Vegetables") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Fruits_And_Vegetable.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(Fruits_And_Vegetable.this, MainActivity.class));
        finish();
    }
}
