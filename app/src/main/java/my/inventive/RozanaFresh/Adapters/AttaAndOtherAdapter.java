package my.inventive.RozanaFresh.Adapters;
...
import my.inventive.RozanaFresh.AttaAndOtherModel;
import my.inventive.RozanaFresh.DescriptionActivity;
import my.inventive.RozanaFresh.ItemClickListner;
import my.inventive.RozanaFresh.Myhelper;
...
public class AttaAndOtherAdapter extends RecyclerView.Adapter<AttaAndOtherAdapter.GridViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final GridViewHolder holder, int position) {
        ...
        holder.item_price.setText("Off Price: \u20B9" + attaAndOtherModel.getItemPrice());
        ...
        //holder.discount_rate.setText("-Rs "+res);
...
//            String sql="CREATE TABLE PRODUCT(_id INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT,PRODUCT_PRICE TEXT,SELLING_PRICE TEXT)";
                if (holder.add.getText() == "Added") {
                    ...
                    String sql1 = "select count(*) from CUSTOMER where ITEMID="+attaAndOtherModel.getItem_id();
