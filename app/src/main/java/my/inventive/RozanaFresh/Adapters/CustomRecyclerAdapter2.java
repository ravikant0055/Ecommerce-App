...
import my.inventive.RozanaFresh.CartActivity;
import my.inventive.RozanaFresh.Item;
    ...
    public void onClick(View v) {
        ...
        if (number[0] > 1) {
           ...
           /* ContentValues values = new ContentValues();
            ...
            database.execSQL("UPDATE CUSTOMER SET QTY = "+number[0]+" WHERE _id="+item_id);
        ...
        holder.product_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               database.execSQL("delete from CUSTOMER where _id="+item_id);
