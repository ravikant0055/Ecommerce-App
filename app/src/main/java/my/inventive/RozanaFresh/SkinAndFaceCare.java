...
public class SkinAndFaceCare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skin_and_face_care);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Skin And Face Care");
        ...
        progressDialog=new ProgressDialog(SkinAndFaceCare.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Skin and Face Care") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SkinAndFaceCare.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(SkinAndFaceCare.this,MainActivity.class));
        finish();
    }
}
