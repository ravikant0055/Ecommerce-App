                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Salt and Sugar")&& seller_id.equals("27")) {
                               ...
                               saltAndSugarModelArrayList.add(new AttaAndOtherModel(u, name, weight, product_price, selling, item_descrip, id, seller_id));
...
*/
    ...
    public void onBackPressed() {
        startActivity(new Intent(SaltAndSugarActivity.this,MainActivity.class));
        finish();
    }
}
