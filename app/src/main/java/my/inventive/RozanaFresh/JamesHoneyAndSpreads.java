...
public class JamesHoneyAndSpreads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_james_honey_and_spreads);

        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("Jams Honey and Spreads");
        ...
        progressDialog=new ProgressDialog(JamesHoneyAndSpreads.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Jams Honey and Spreads") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(JamesHoneyAndSpreads.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(JamesHoneyAndSpreads.this,MainActivity.class));
        finish();
    }
}
