...
public class Myhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        //price real
        String sql="CREATE TABLE CUSTOMER(_id INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT,PRODUCT_PRICE TEXT,SELLING_PRICE TEXT,QTY INTEGER,SELEER_ID TEXT,ITEM_IMAGE TEXT,ITEMID TEXT,WEIGHT TEXT)";
        db.execSQL(sql);
