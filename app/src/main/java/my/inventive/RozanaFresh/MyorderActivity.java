...
public class MyorderActivity extends AppCompatActivity {
    private static final String apiurl="https://simplyfied.co.in/groceryapp/history.php";
       ...
       // Toast.makeText(this, ""+personelid, Toast.LENGTH_SHORT).show();
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            {
                                myorders.add(new Myorder(dateOfOrder,timmeOfOrder,orderid,order_status,item_count,total_amount,address));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                params.put("userId", personelid);
                params.put("sellerId","27");
                return params;
            }
        };
