...
public class KetchupsAndSoups extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ketchups_and_soups);
        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle("ketchups and Sauces");
        ...
        progressDialog=new ProgressDialog(KetchupsAndSoups.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("ketchups and Sauces") && seller_id.equals("27")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(KetchupsAndSoups.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(KetchupsAndSoups.this,MainActivity.class));
        finish();
    }
}
